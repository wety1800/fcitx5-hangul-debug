...
基于 [fcitx5-android](https://github.com/fcitx5-android/fcitx5-android) 和 [Fcitx Android for BiBi Keyboard](https://github.com/BryceWG/fcitx5-android-bibi-keyboard/releases) 的韩语输入法键盘显示修复版本。

## 说明

自用，使用 vibe coding 创建，基础功能正常，韩语键盘状态下，长按无法显示键盘上的符号。
